...
jawaban.append("Python adalah bahasa pemrograman yang interaktif dan berorientasi objek. Python menggabungkan kekuatan luar biasa dengan sintaksis yang sangat jelas.")
jawaban.append("Python Software Foundation adalah organisasi nirlaba independen yang memegang hak cipta pada Python versi 2.1 dan yang terbaru.")
...
jawaban.append("Python adalah general-purpose programming language tingkat tinggi yang dapat diterapkan ke banyak kelas masalah yang berbeda.")
...
jawaban.append("Ya, lihat wiki python.org di https://wiki.python.org/moin/PythonBooks.")
